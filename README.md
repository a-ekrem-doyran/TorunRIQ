...
⚖️ Lisans / License
Bu proje GNU GPLv3 lisansı ile korunmaktadır. Bu, yazılımın her zaman özgür kalacağı ve ticari amaçlarla kapalı kaynak olarak kullanılamayacağı anlamına gelir.
This project is protected under the GNU GPLv3 license. This means the software will always remain free and cannot be used commercially as closed source.

🤝 Katkıda Bulunun / Contributing
Bu proje bir Açık Kaynak girişimidir.
This project is an open-source initiative.

Developer: Abdullah Ekrem Doyran -  Computer Engineering Student.
